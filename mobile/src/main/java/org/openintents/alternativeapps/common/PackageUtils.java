...
import org.openintents.alternativeapps.packageinfo.AsyncManifestExporter;
import org.openintents.alternativeapps.packageinfo.AsyncManifestExporter.ManifestExporterListener;
    ...
    public static void exportAPK(final Activity activity, final PackageInfo info) {
        ...
        if (FileUtils.copyFile(srcFile, dstFile)) {
            Snackbar.make(activity.findViewById(android.R.id.content),
                    ...
                    .setAction("Click here to open it now", new OnClickListener() {
            ...
            Snackbar.make(activity.findViewById(android.R.id.content),
                    "An error occured while exporting the APK",
