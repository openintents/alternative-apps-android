...
public class PermissionStyler {
	...
	public static String getPermissionName(final String permission,
		...
		if (name.equals(Manifest.permission.ACCESS_CHECKIN_PROPERTIES)) {
			...
			name = context.getString(R.string.permlab_mount_format_filesystems_default);
		} else if (name.equals(Manifest.permission.MOUNT_UNMOUNT_FILESYSTEMS)) {
			name = context
					.getString(R.string.permlab_mount_unmount_filesystems_default);
			...
			name = context.getString(R.string.permlab_sdcardRead_default);
			...
			name = context.getString(R.string.permlab_reboot_default);
			...
			name = context.getString(R.string.permlab_wakeLock_default);
			...
			name = context.getString(R.string.permlab_sdcardWrite_default);
